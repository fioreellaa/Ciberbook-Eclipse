...
<html>
	<head>
	<%
	Libros bookie = (Libros) request.getAttribute("bookupdate");
	%>
	<meta charset="UTF-8">
	...
	<div class="">
	   ...
	   <div class="contenedor row" style="padding: 5% 10%; margin:0;">
	   		<h3>Editar libro</h3><br><br>
	   		<section class="col-md-9" >
	   			<form class="update-book " id="update-book" method="GET" action="LibrosController">
				<input type="hidden" name="command" value="update">
	   			...
	   			<div class="col-md-9">		
					...
					<input class="form-text col-md-4" type="text" name="book-id" id="book-id" value="${ bookupdate.id }" readonly>
					
					<br>
					
					<label class="form-label col-md-2" for="book-tittle">Titulo del libro</label>	
					<input class="form-text col-md-4" type="text" name="book-tittle" id="book-tittle" required value="${ bookupdate.titulo }">
					...
					<input class="form-text col-md-4" type="text" name="book-isbn" id="book-isbn" required value="${ bookupdate.isbn }">
					
					<br>
					
					<label class="form-label col-md-2" for="book-year">Año</label>	
					<input class="form-text col-md-4" type="text" name="book-year" id="book-year" value="${ bookupdate.anioPublicacion }">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<select class="form-select col-md-3" name="book-category" required>
							<% 
					...
					<input class="form-text col-md-4" type="number" name="book-price" id="book-price" min="0" step="0.01" required value="${ bookupdate.precio }">
				
					<br>
				
					<label class="form-label col-md-2" for="book-stock">Cantidad</label>
					<input class="form-text col-md-4" type="number" name="book-stock" id="book-stock" min="0" required value="${ bookupdate.stock }">
					...
					<input class="col-md-5"
						...
						><!--  value="${ bookupdate.imagen }"-->
					<br>
				
					<label class="form-label col-md-2" for="book-description">Descripción</label>	
					<textarea class="form-text col-md-7" rows="10" name="book-description" id="book-description" required >${ bookupdate.descripcion }</textarea>
	  		...
	  		<aside class="col-md-3">
	  			<center>
	  				<button class="btn btn-outline-warning me-2" onclick="location.href='LibrosController'">Listado</button>
	  					...
	  					<div style="text-aling:center;" class="preview-container" id="preview-container" style=" display:flex;">
	  						<img alt="" src="img/${ bookupdate.imagen }">
	  					</div>
	  			</center>
	  		</aside>
	   		</div>
